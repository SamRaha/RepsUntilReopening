         ...
         */}
            <div className="App-header">
              <div className="timer-container">
                ...
                <Timer dateToExpire={new Date(2021, 2, 9, 25, 56)} message={"WORKOUT WITH A FRIEND IN THE PARK"} backgroundColor="#F15BB5" numberOfImages={6} onlyShowDays={true} classNamePicture="muscle-men-6" classNameCard="muscle-men-card-6"  key={"4"} />
                <Timer dateToExpire={new Date(2021, 2, 10, 26, 56)} message={"WORKOUT WITH A FRIEND IN THE PARK"} backgroundColor="#9B5DE5" numberOfImages={12} onlyShowDays={true}  classNameCard="muscle-men-card-12" key={"5"} />
            </div>
            </div>
        <Footer/>
        </div>
